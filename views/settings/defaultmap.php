...
<tr valign="top">
	<td colspan="2" style="padding:20px 0 0 0;">
		<label>
			...
			<?php _e('Center Default Map Using User\'s Location (Map will default to above if geolocation is unavailable or refused by the user).', 'wpsimplelocator'); ?>
		</label>
	</td>
</tr>
<tr valign="top">
	<td colspan="2" style="padding:20px 0 0 0;">
		<label>
			<input type="checkbox" name="wpsl_default_map[load_locations]" value="true" <?php if ( $this->settings_repo->defaultMap('load_locations') == 'true' ) echo 'checked'; ?> />
			<?php _e( 'Automatically show results on page load', 'wpsimplelocator' ); ?>
		</label>
	</td>
</tr>
