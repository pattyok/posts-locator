...
<!-- Carkeek Additions - allow admin to set a field for the pin -->
<tr valign="top">
	<th scope="row"><?php _e('Custom Map Pin Field', 'wpsimplelocator'); ?></th>
	<!-- TODO Make this a select field -->
	<td>
		<input id="wpsl_map_pin_field" type="text" name="wpsl_map_pin_field" value="<?php echo get_option('wpsl_map_pin_field'); ?>" />
	</td>
</tr>
<tr valign="top">
	<th scope="row"><?php _e('Use Map Clustering', 'wpsimplelocator'); ?></th>
	<td>
		<label>
			<input type="checkbox" value="true" name="wpsl_map_pin_cluster" <?php if ( get_option('wpsl_map_pin_cluster') == 'true') echo 'checked'; ?> />
			<?php _e('Yes', 'wpsimplelocator'); ?>
		</label><br />
	</td>
</tr>
<tr valign="top">
	<th scope="row"><?php _e('Map Clustering Image Directory', 'wpsimplelocator'); ?></th>
	<td>
		<input id="wpsl_map_pin_cluster_directory" style="width: 80%" type="text" name="wpsl_map_pin_cluster_directory" value="<?php echo get_option('wpsl_map_pin_cluster_directory'); ?>" />
	</td>
</tr>
<!-- End Carkeek Addiitions -->
<tr valign="top">
