...
class FormShortcode
{
	...
	*/
	private function enqueueScripts()
	{
		...
		if ( $this->options['markerclustering'] !== false) {
			wp_enqueue_script('simple-locator-map-clustering');
		}
	}
	...
	*/
	private function setOptions($options)
	{
		$this->options = shortcode_atts(array(
			...
			'resultswrapper' => '.wpsl-resultswrapper',
			...
			'textplaceholder'=> __('Enter a name or keyword', 'wpsimplelocator'),
			'ajax' => 'true',
			'perpage' => $this->settings_repo->resultsPerPage(),
			'noresultstext' => __('No results found.', 'wpsimplelocator'),
			'taxonomies' => '',
			'taxonomiestyle' => 'checkbox',
	...
	*/
	private function localizeOptions()
	{
		$localized_data = array(
			...
			'resultswrapper' => $this->options['resultswrapper'],
			'clusters' => $this->options['markerclustering'],
		);
