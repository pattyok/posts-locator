...
class PublicDependencies extends DependencyBase
{
	...
	*/
	public function scripts()
	{
		...
		wp_register_script(
			'simple-locator',
			$this->plugin_dir . '/assets/js/source/simple-locator.js',
			$dependencies,
			$this->version,
			true
		);
		...
		wp_register_script(
			...
			$this->plugin_dir . '/assets/js/source/simple-locator-non-ajax-results.js',
		...
		wp_register_script(
			'simple-locator-lodash',
			$this->plugin_dir . '/assets/js/lodash.js',
			array('jquery'),
			$this->version,
			true
		);
		...
		wp_register_script(
			'simple-locator-oms',
			$this->plugin_dir . '/assets/js/oms.min.js',
			array('jquery'),
			$this->version,
			true
		);
		...
		$localized_data = array(
			...
			'default_load_locations'	=> $this->settings_repo->defaultMap('load_locations'),
