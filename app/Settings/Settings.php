...
class Settings
{
	...
	*/
	public function registerSettings()
	{
		...
		register_setting( 'wpsimplelocator-general', 'wpsl_map_pin_field' );
		register_setting( 'wpsimplelocator-general', 'wpsl_map_pin_cluster' );
		register_setting( 'wpsimplelocator-general', 'wpsl_map_pin_cluster_directory' );
